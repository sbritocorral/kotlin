...
class IfNullExpressionsFusionLowering(val context: JvmBackendContext) : FileLoweringPass {
    ...
    private inner class Transformer(private val currentFile: IrFile) : IrElementTransformerVoid() {
        ...
        private fun simplifyIfNull(
            ...
            return when {
                ...
                subjectExpr is IrGetValue && !subjectExpr.type.isNullable() && subjectExpr.symbol != subjectVariable.symbol ->
                    ifNotNullResultExpr
    ...
    private fun constructIfNullExpr(
        ...
        context.createJvmIrBuilder(subjectVariable.symbol, subjectVariable.startOffset, subjectVariable.endOffset)
            .irBlock {
                +subjectVariable
                +irIfNull(
                    ifNullExpr.type,
